...
Status of every ticket at time of writing: `Done` for PR-001, PR-002, PR-004, PR-005, PR-010, PR-013, PR-014, PR-020; `In Review` for PR-011; `Ready` for PR-003, PR-012, PR-021; `Backlog` for everything else.
...
| PR-003 | Decision: go / no-go / pivot — **drafted: GO scoped to PR-042, `docs/decisions/PR-003-go-no-go.md`, awaiting both signatures** | Joint | P0 | 1 | Decision | — |
